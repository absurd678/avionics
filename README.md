...
```
cd existing_repo
git remote add origin https://hub.mos.ru/uav_control_server/communication_module.git
git branch -M main
...
- [ ] [Настройте интеграцию](https://hub.mos.ru/uav_control_server/communication_module/-/settings/integrations)
